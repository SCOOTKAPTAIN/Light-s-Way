...
{
    public class ReapersHarvest3: CardActionBase
    {
        public override CardActionType ActionType => CardActionType.ReapersHarvest3;
        public override void DoAction(CardActionParameters actionParameters)
        {
            ...
            FxManager.PlayFxAtPosition(anchor.position, FxType.ReapersHarvest3, 0.4f);
            ...
            if (AudioManager != null)
                AudioManager.PlayOneShot(AudioActionType.ReapersHarvest3);
