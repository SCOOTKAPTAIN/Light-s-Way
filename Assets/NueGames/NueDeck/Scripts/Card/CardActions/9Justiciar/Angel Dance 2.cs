...
{
    public class AngelDance2: CardActionBase
    {
        public override CardActionType ActionType => CardActionType.AngelDance2;
        public override void DoAction(CardActionParameters actionParameters)
        {
            ...
            FxManager.PlayFxAtPosition(actionParameters.TargetCharacter.transform.position, FxType.AngelDance2);
            ...
            targetCharacter.CharacterStats.ApplyStatus(StatusType.Fragile, 1);


            if (AudioManager != null)
                AudioManager.PlayOneShot(AudioActionType.AngelDance2);
