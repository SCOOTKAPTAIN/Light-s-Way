...
{
    public class HailStorm: CardActionBase
    {
        public override CardActionType ActionType => CardActionType.HailStorm;
        public override void DoAction(CardActionParameters actionParameters)
        {
            ...
            var value = GameManager.PersistentGameplayData.proficiency + actionParameters.Value
             ...
             FxManager.Instance.PlayFxAtPosition(anchor.position, FxType.HailStorm, 0.2f);              
