...
{
    public class LeaveNoOpening2: CardActionBase
    {
        public override CardActionType ActionType => CardActionType.LeaveNoOpening2;
        public override void DoAction(CardActionParameters actionParameters)
        {
            ...
            FxManager.Instance.PlayFxAtPosition(anchor.position, FxType.LeaveNoOpening2, 0.2f);
            ...
            if (AudioManager != null)
                AudioManager.PlayOneShot(AudioActionType.LeaveNoOpening2);
