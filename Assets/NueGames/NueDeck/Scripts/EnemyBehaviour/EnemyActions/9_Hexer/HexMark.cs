...
{
    public class HexMark : EnemyActionBase
    {
        public override EnemyActionType ActionType => EnemyActionType.HexMark;
        ...
        public override void DoAction(EnemyActionParameters actionParameters)
        {
            ...
            if (actionParameters.SelfCharacter.CharacterStats.StatusDict[StatusType.TotalAssimilation].IsActive)
                target.CharacterStats.ApplyPermanentMaxHealthReduction(10);
            else
                target.CharacterStats.ApplyStatus(StatusType.Necrosis, 5, actionParameters.SelfCharacter);
